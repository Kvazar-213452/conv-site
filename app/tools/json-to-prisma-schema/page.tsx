...
import JsonToPrisma from "./JsonToPrisma";
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "/tools/json-to-prisma-schema",
  },
  openGraph: {
    ...
    url: `${MAIN_DOMEN}tools/json-to-prisma-schema`,
    type: "website"
  },
  robots: {
    index: true,
...
export default function JsonToPrismaPage() {
  return (
    <JsonToPrisma />
  );
}